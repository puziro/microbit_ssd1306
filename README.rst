...
You should connect the device窶冱 SCL pin to micro:bit pin 19, and the device窶冱 SDA pin to micro:bit pin 20. You also must connect the device窶冱 ground to the micro:bit ground (pin GND). 
